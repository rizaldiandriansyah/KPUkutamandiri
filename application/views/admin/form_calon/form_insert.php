...
<head>
  ...
  <title>KPU Kutamandiri | Tambah Calon</title>
            ...
            <div class="nav-tabs-custom">
              <div class="tab-content">
                ...
                <div class="tab-pane active" id="settings">
                  <form class="form-horizontal" action="<?= base_url('admin/proses_calon_insert') ?>" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group">
                      <label for="no_urut" class="col-sm-2 control-label">No. Urut</label>
                    ...
                    <div class="form-group">
                      <label for="dapil" class="col-sm-2 control-label">Dapil</label>

                      <div class="col-sm-10">
                      <select class="form-control" name="dapil" style="width:110%;margin-right: 18px;">
