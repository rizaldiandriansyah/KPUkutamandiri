...
<head>
  ...
  <title>Si-Iventory | Data Barang Keluar</title>
            ...
            <?php } ?>
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name="id_transaksi" style="margin-left:82px;width:20%;display:inline;" class="form-control" readonly="readonly" value="<?=$d->id_transaksi?>">
                </div>
                <div class="form-group">
                  <label for="nama_instansi" style="margin-left:220px;display:inline;">Nama Instansi</label>
                  <input type="text" name="nama_instansi" style="margin-left:70px;width:20%;display:inline;" class="form-control" readonly="readonly" value="<?=$d->nama_instansi?>">
                </div>
                <div class="form-group">
               ...
               <!--  <div class="form-group">
                ...
                <div class="form-group">
                  <label for="barang_butuh" style="margin-left:220px;display:inline;">Barang Ditambahkan</label>
                  <input type="text" name="barang_butuh" style="margin-left:28px;width:20%;display:inline;" class="form-control" readonly="readonly" value="<?=$d->barang_butuh?>">
                </div>
                ...
                <div class="form-group" style="display:inline-block;">
                  ...
                  <input type="text" name="nama_barang" style="width:90%;margin-right: 67px;" class="form-control" id="nama_Barang"readonly="readonly" value="<?=$d->nama_barang?>">
              </div>
                <div class="form-group" style="display:inline-block;">
                  <label for="satuan" style="width:73%;">Satuan</label>
                  <select class="form-control" name="satuan" style="width:200px;margin-right: 18px;">
                    <?php foreach($list_satuan as $s){?>
                      <?php if($d->satuan == $s->nama_satuan){?>
                    <option readonly="readonly"value="<?=$d->satuan?>" selected=""><?=$d->satuan?></option>
                    <?php }else{?>
                    <optionreadonly="readonly" value="<?=$s->kode_satuan?>"><?=$s->nama_satuan?></option>
                      <?php } ?>
                      <?php } ?>
                  </select>
              </div>
              <div class="form-group" style="display:inline-block;">
                <label for="jumlah" style="margin-left:34px;">Jumlah</label>
                <input type="number" name="jumlah" style="width:65px;margin-left:34px;margin-right:20px;" class="form-control" id="jumlah" max="<?=$d->jumlah?>" value="<?=$d->jumlah?>">
            </div>
            <!-- <div class="form-group" style="display:inline-block;">
                <label for="barang_butuh" style="">Barang Ditambahkan</label>
                <input type="number" style="width:150px;" name="barang_butuh" readonly="readonly" class="form-control" id="barang_butuh" value="<?=$d->nama_instansi?>">
            </div> -->
            <div class="form-group">
                  <label for="tanggal" style="margin-left: 12px;">Keterangan Tambahan</label>
                  <input type="text" name="note" style="margin-left:105px;width:50%;height:50%;display:inline;" class="form-control">
                </div>
            <?php } ?>
              <!-- /.box-body -->
