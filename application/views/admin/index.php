...
<head>
  ...
  <title>KPU Kutamandiri | Dashboard</title>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <li class="treeview">
          ...
          <li class="treeview">
            <a href="#">
              <i class="fa  fa-calculator"></i> <span>Rekapitulasi Suara</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li><a href="<?php echo base_url('rekapitulasi/jumlah_suara_rw') ?>"><i class="fa fa-circle-o"></i> Pemilihan RW</a></li>
              <li><a href="<?php echo base_url('rekapitulasi/jumlah_suara_rt1') ?>"><i class="fa fa-circle-o"></i> Pemilihan RT 01</a></li>
              <li><a href="<?php echo base_url('rekapitulasi/jumlah_suara_rt2') ?>"><i class="fa fa-circle-o"></i> Pemilihan RT 02</a></li>
              <li><a href="<?php echo base_url('rekapitulasi/jumlah_suara_rt3') ?>"><i class="fa fa-circle-o"></i> Pemilihan RT 03</a></li>
            </ul>
          </li>
            ...
            <div class="small-box bg-blue">
              <div class="inner">
                ...
                <?php } else { ?>
                  <h3>0</h3>
                <?php } ?>
                <p>Jumlah Suara Masuk Calon Ketua RW </p>
              </div>
              <div class="icon">
                <i class="ion ion-stats-bars"></i>
              </div>
              <a href="<?= base_url('rekapitulasi/jumlah_suara_rw') ?>" class="small-box-footer">Lihat Detail <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
            ...
            <div class="small-box bg-green">
              <div class="inner">
                ...
                <?php } else { ?>
                  <h3>0</h3>
                <?php } ?>
                <p>Jumlah Suara Masuk Calon RT 01</p>
              </div>
              <div class="icon">
                <i class="ion ion-stats-bars"></i>
              </div>
              <a href="<?= base_url('rekapitulasi/jumlah_suara_rt1') ?>" class="small-box-footer">Lihat Detail <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
            ...
            <div class="small-box bg-yellow">
              <div class="inner">
                ...
                <?php } else { ?>
                  <h3>0</h3>
                <?php } ?>
                <p>Jumlah Suara Masuk Calon RT 02</p>
              </div>
              <div class="icon">
                <i class="ion ion-stats-bars"></i>
              </div>
            ...
            <div class="small-box bg-red">
              <div class="inner">
                ...
                <?php } else { ?>
                  <h3>0</h3>
                <?php } ?>
                <p>Jumlah Suara Masuk Calon RT 03</p>
              </div>
              <div class="icon">
                <i class="ion ion-stats-bars"></i>
              </div>
            ...
            <div class="small-box bg-red">
              <div class="inner">
                <?php if (!empty($dataPemilih)) { ?>
                  <h3><?= $dataPemilih ?></h3>
                  <?php $jumlah_pemilih = $dataPemilih?>
                <?php } ?>
                <p>Pemilih</p>
              </div>
              <div class="icon">
              ...
              <a href="<?= base_url('admin/pemilih') ?>" class="small-box-footer">Lihat Detail <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
           <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-yellow">
              <div class="inner">
                <?php if (!empty($calon)) { ?>
                  <h3><?= $calon ?></h3>
                <?php } ?>
                <p>Calon Ketua RW dan RT</p>
              </div>
              <div class="icon">
                <i class="ion ion-person"></i>
              </div>
              <a href="<?= base_url('admin/calon') ?>" class="small-box-footer">Lihat Detail <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
        ...
        <div class="col-xs-12">
          <div class="box box-solid">
            <div class="box-header">
              ...
              <h3 class="box-title">Chart Rekapitulasi pemilih</h3>
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-xs-6 col-md-3 text-center">
                  <?php $pers_rw = $suara_rw/$jumlah_pemilih * 100?>
                  <input type="text" class="knob" value="<?php echo $pers_rw?>" data-width="120" data-height="120" data-fgColor="#3c8dbc" data-readonly="true">

                  <div class="knob-label"><a href="<?= base_url('rekapitulasi/jumlah_suara_rw') ?>">REKAPITULASI KETUA RW KUTAMANDIRI</a></div>
                </div>
                <!-- ./col -->
                <div class="col-xs-6 col-md-3 text-center">
                  <?php $pers_rt1 = $suara_rt1/$pemilih_rt1*100?>
                  <input type="text" class="knob" value="<?php echo $pers_rt1?>" data-width="120" data-height="120" data-fgColor="#f56954" data-readonly="true">

                  <div class="knob-label"><a href="<?= base_url('rekapitulasi/jumlah_suara_rt1') ?>">REKAPITULASI KETUA RT 01</div>
                </div>
                <!-- ./col -->
                <?php 
                $total2 = 0;
                if (!empty($suara_rt2)) { ?>
                  <?php foreach ($suara_rt2 as $d) { 
                    $suara2 = $d->jumlah_suara;
                    $total2 = $total2+$suara2;
                    $suara_rt2= $total2;
                    ?>
                  <?php }} ?>
                  <?php $pers_rt2 = $suara_rt2/$pemilih_rt2*100?>
                <div class="col-xs-6 col-md-3 text-center">
                  <input type="text" class="knob" value="<?php echo $pers_rt2?>" data-width="120" data-height="120" data-fgColor="#00a65a" data-readonly="true">

                  <div class="knob-label"><a href="<?= base_url('rekapitulasi/jumlah_suara_rt2') ?>">REKAPITULASI KETUA RT 02</div>
                </div>
                <!-- ./col -->
                <?php 
                $total3 = 0;
                if (!empty($suara_rt3)) { ?>
                  <?php foreach ($suara_rt3 as $d) { 
                    $suara3 = $d->jumlah_suara;
                    $total3 = $total3+$suara3;
                    $suara_rt3= $total3;
                    ?>
                  <?php }} ?>
                  <?php $pers_rt3 = $suara_rt3/$pemilih_rt3*100?>
                <div class="col-xs-6 col-md-3 text-center">
                  <input type="text" class="knob"  value="<?php echo $pers_rt3?>" data-width="120" data-height="120" data-fgColor="#00c0ef" data-readonly="true">

                  <div class="knob-label"><a href="<?= base_url('rekapitulasi/jumlah_suara_rt3') ?>">REKAPITULASI KETUA RT 03</div>
                </div>
                <!-- ./col -->
              </div>
              <!-- /.row -->
