...
<head>
  ...
  <title>KPU Kutamandiri | Daerah Pemilihan </title>
  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Data Daerah Pemilihan Desa Kutamandiri
        </h1>
        <ol class="breadcrumb">
          <li><a href="<?= base_url('admin') ?>"><i class="fa fa-dashboard"></i> Home</a></li>
          <li><a href="<?= base_url('admin/dapil') ?>" class="active">Daerah Pemilihan</a></li>
        </ol>
      </section>
          ...
          <div class="col-xs-12">
            ...
            <div class="box">
              <div class="box-header">
                <h3 class="box-title"><i class="fa fa-fw fa-users" aria-hidden="true"></i> Daerah Pemilihan Desa Kutamandiri</h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                ...
                <a href="<?= base_url('admin/form_dapil') ?>" style="margin-bottom:10px;" type="button" class="btn btn-primary" name="tambah_data"><i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah Data</a>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <tr>
                      <?php if (is_array($list_dapil)) { ?>
                        <?php foreach ($list_dapil as $dd) : ?>
                          <td><?= $dd->id ?></td>
                          <td><?= $dd->detail_dapil ?></td>
                          <td><a type="button" class="btn btn-info" href="<?= base_url('admin/update_dapil/' . $dd->id) ?>" name="btn_update" style="margin:auto;"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                          <td><a type="button" class="btn btn-danger btn-delete" href="<?= base_url('admin/proses_delete_dapil/' . $dd->id) ?>" name="btn_delete" style="margin:auto;"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                        </tr>
                      <?php endforeach; ?>
                    <?php } else { ?>
