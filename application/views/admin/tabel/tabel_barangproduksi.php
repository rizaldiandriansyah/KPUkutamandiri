...
<head>
  ...
  <title>Si-Iventory | Table Barang Produksi</title>
  ...
  <div class="wrapper">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="<?= base_url('admin/form_barangproduksi') ?>"><i class="fa fa-circle-o"></i> Tambah Barang Produksi</a></li>
            </ul>
          </li>
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="<?= base_url('admin/tabel_barangproduksi') ?>"><i class="fa fa-circle-o"></i> Tabel Barang Produksi</a></li>
            </ul>
          </li>
          <li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Tabel Barang Produksi
        </h1>
        <ol class="breadcrumb">
          <li><a href="<?= base_url('admin') ?>"><i class="fa fa-dashboard"></i> Home</a></li>
          <li>Tables</li>
          <li class="active"><a href="<?= base_url('admin/tabel_barangproduksi') ?>">Tabel Barang Produksi</a></li>
        </ol>
      </section>
          ...
          <div class="col-xs-12">
            ...
            <div class="box">
              ...
              <div class="box-body">
                ...
                <a href="<?= base_url('admin/form_barangproduksi') ?>" style="margin-bottom:10px;" type="button" class="btn btn-primary" name="tambah_data"><i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah Data</a>
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      <th>No</th>
                      <th>Kode Barang Produksi</th>
                    ...
                    <tr>
                      <?php if (is_array($list_data)) { ?>
                        ...
                        <?php foreach ($list_data as $dd) : ?>
                          <td><?= $no ?></td>
                          <td><?= $dd->kode_barangproduksi ?></td>
                          <td><?= $dd->nama_barangproduksi ?></td>
                          <td><a type="button" class="btn btn-info" href="<?= base_url('admin/update_barangproduksi/' . $dd->id_barangproduksi) ?>" name="btn_update" style="margin:auto;"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                          <td><a type="button" class="btn btn-danger btn-delete" href="<?= base_url('admin/delete_barangproduksi/' . $dd->id_barangproduksi) ?>" name="btn_delete" style="margin:auto;"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                        </tr>
                        <?php $no++; ?>
                      <?php endforeach; ?>
                    <?php } else { ?>
