...
<head>
  ...
  <title>KPU Kutamandiri | Rekapitulasi Suara </title>
  ...
  <div class="wrapper">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              <li class ="treeview active"><a href="<?php echo base_url('rekapitulasi/jumlah_suara_rw') ?>"><i class="fa fa-circle-o"></i> Pemilihan RW</a></li>
              <li class =""><a href="<?php echo base_url('rekapitulasi/jumlah_suara_rt1') ?>"><i class="fa fa-circle-o"></i> Pemilihan RT 01</a></li>
              <li class =""><a href="<?php echo base_url('rekapitulasi/jumlah_suara_rt2') ?>"><i class="fa fa-circle-o"></i> Pemilihan RT 02</a></li>
              <li class =""><a href="<?php echo base_url('rekapitulasi/jumlah_suara_rt3') ?>"><i class="fa fa-circle-o"></i> Pemilihan RT 03</a></li>
            </ul>
          </li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Rekapitulasi Suara Pemilihan Ketua RW
        </h1>
        <ol class="breadcrumb">
          <li><a href="<?= base_url('admin') ?>"><i class="fa fa-dashboard"></i> Home</a></li>
          <li><a href="<?= base_url('') ?>" class="">Rekapitulasi Suara</a></li>
          <li><a href="<?= base_url('rekapitulasi/jumlah_suara_rw') ?>" class="active"></a>Pemilihan RW</li>
        </ol>
      </section>
          ...
          <div class="col-xs-12">
            ...
            <div class="box">
              <div class="box-header">
                <h3 class="box-title"><i class="fa fa-fw fa-users" aria-hidden="true"></i> Suara Masuk</h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-xs-6 col-md-3 text-center">
                  <input type="text" class="knob" value="59" data-width="120" data-height="120" data-fgColor="#3c8dbc" data-readonly="true">

                  <div class="knob-label">REKAPITULASI KETUA RW KUTAMANDIRI</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-6 col-md-3 text-center">
                  <input type="text" class="knob" value="21" data-width="120" data-height="120" data-fgColor="#f56954" data-readonly="true">

                  <div class="knob-label">REKAPITULASI KETUA RT 01</div>
                </div>
                <!-- ./col -->
                
                <div class="col-xs-6 col-md-3 text-center">
                  <input type="text" class="knob" value="24" data-width="120" data-height="120" data-fgColor="#00a65a" data-readonly="true">

                  <div class="knob-label">REKAPITULASI KETUA RT 02</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-6 col-md-3 text-center">
                  <input type="text" class="knob"  value="30" data-width="120" data-height="120" data-fgColor="#00c0ef" data-readonly="true">

                  <div class="knob-label">REKAPITULASI KETUA RT 03</div>
                </div>
                <!-- ./col -->
              </div>
              <!-- /.row -->
