        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              ...
              <li class="active"><a href="<?= base_url('admin/form_barangproduksi') ?>"><i class="fa fa-circle-o"></i> Tambah Barang Produksi</a></li>
            </ul>
          </li>
