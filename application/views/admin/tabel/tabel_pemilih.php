...
<head>
  ...
  <title>Si-Pemilu | Table Pemilih</title>
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview active">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="<?= base_url('admin/tabel_barangproduksi') ?>"><i class="fa fa-circle-o"></i> Tabel Barang Produksi</a></li>
            </ul>
          </li>
          <li>
                    ...
                    <tr>
                      <?php if (is_array($list_data)) { ?>
                        ...
                        <?php foreach ($list_data as $dd) : ?>
                          ...
                          <td><a type="button" class="btn btn-info" href="<?= base_url('admin/update_pemilih/' . $dd->nik) ?>" name="btn_update" style="margin:auto;"><i class="fa fa-pencil" aria-hidden="true"></i></a></td>
                          <td><a type="button" class="btn btn-danger btn-delete" href="<?= base_url('admin/delete_pemilih/' . $dd->nik) ?>" name="btn_delete" style="margin:auto;"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                        </tr>
                        <?php $no++; ?>
                      <?php endforeach; ?>
                    <?php } else { ?>
