    ...
    <tbody>
      <tr>
        ...
        <?php foreach($list_data as $dd): ?>
          ...
          <td><?=$dd->barang_tambahan?></td>
          <td><?=$dd->satuan?></td>
          <td><?=$dd->jumlah?></td>
          <td><?=$dd->note?></td>
          <td><a type="button" class="btn btn-danger btn-report"  href="<?=base_url('report/barangKeluar/'.$dd->id_transaksi.'/'.$dd->tanggal_keluar.'/'.$dd->nama_instansi)?>" name="btn_report" style="margin:auto;"><i class="fa fa-file-text" aria-hidden="true"></i></a></td>
      </tr>
    <?php $no++; ?>
    <?php endforeach;?>
    <?php }else { ?>
