...
<head>
  ...
  <title>Si-Pemilu | Edit Calon</title>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="<?= base_url('admin/calon') ?>">Data Calon</a></li>
            ...
            <div class="container">
              ...
              <div class="box box-primary" style="width:94%;">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-archive" aria-hidden="true"></i> Update Data Calon</h3>
                </div>
                <!-- /.box-header -->
                <!-- form start -->
                <div class="container">
                  <form action="<?= base_url('admin/proses_calon_update') ?>" role="form" method="post">
                    ...
                    <div class="box-body"style="padding-left: 0px;padding-right: 0px;width: 650px;">
                      <div class="form-group">
                        <?php foreach ($list_data as $d) { ?>
                          <div class="box-body">
                            <div class="box-footer">
                                <label for="nik" style="width:73%;">NIK</label>
                                <input type="text" required name="nik" style="width: 90%;" class="form-control" id="nik" placeholder="NIK" value="<?= $d->nik ?>">
                            </div>

                            <div class="box-footer">
                                <label for="nama" style="width:73%;">Nama</label>
                                <input type="text" required name="nama" style="width:90%" class="form-control" id="nama" placeholder="Nama" value="<?= $d->nama ?>">
                            </div>

                            <div class="box-footer">
                                <label for="tempat_lahir" style="width:73%;">No Urut</label>
                                <input type="text" required name="no_urut" style="width:90%;margin-right: 67px;" class="form-control" id="no_urut" placeholder="No Urut" value="<?= $d->no_urut ?>">
                            </div>

                            <div class="box-footer">
                                <label for="visi" style="width:73%;">Visi</label>
                                <input type="type" name="visi" style="width:73%;margin-right: 67px;" class="form-control" id="visi" placeholder="Visi" value="<?= $d->visi ?>">
                            </div>

                            <div class="box-footer">
                                <label for="misi" style="width:73%;">Misi</label>
                                <input type="type" name="misi" style="width:73%;margin-right: 67px;" class="form-control" id="misi" placeholder="Misi" value="<?= $d->misi ?>">
                            </div>

                            <div class="box-footer">
                                <label for="dapil" style="width:73%;">Dapil</label>
                                <input type="type" name="dapil" style="width:73%;margin-right: 67px;" class="form-control" id="dapil" placeholder="Dapil" value="<?= $d->dapil ?>">
                            </div>
